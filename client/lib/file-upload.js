...
/**
 * Read file contents as a Base64 string (without the data-URL prefix).
 * Uses the browser's native encoder; a manual byte-by-byte loop freezes
 * the tab for seconds-to-minutes on multi-MB files.
 * @param {File} file
 * @returns {Promise<string>}
 */
